...
async def resume_project(
    ...
    job_data = {
        ...
        "_ui_settings": {
            ...
            "colmap_fisheye_use_calibration": saved_settings.get("colmap_fisheye_use_calibration", True),
            ...
            "colmap_fisheye_fov_deg":         saved_settings.get("colmap_fisheye_fov_deg", 130.0),
            "colmap_fisheye_raw_fov_deg":     saved_settings.get("colmap_fisheye_raw_fov_deg", 190.0),
            "colmap_fisheye_raw_swap_lenses": saved_settings.get("colmap_fisheye_raw_swap_lenses", False),
